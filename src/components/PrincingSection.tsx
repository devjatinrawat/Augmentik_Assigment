    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-8 mt-12 max-sm:max-w-sm max-sm:mx-auto">
        <div className="border rounded-md p-6">
          ...
          <div className="mt-6">
            <h3 className="text-2xl font-semibold">$10 <sub className="text-gray-400 text-xs">per month</sub></h3>
          </div>
          <div className="mt-6">
            ...
            <button type="button" className="w-full mt-6 px-2 py-2 text-sm font-semibold text-white bg-cyan-400 hover:bg-blue-600 rounded-md">Buy now</button>
          </div>
        </div>
        <div className="border rounded-md p-6">
          <h3 className="text-2xl font-semibold mb-1 flex items-center">Professional <span className="px-2 py-1 text-xs font-semibold text-white bg-cyan-400 rounded-md ml-3">Best Deal</span></h3>
          <p className="text-sm text-gray-500">For Individuals and Largest Teams</p>
          <div className="mt-6">
            <h3 className="text-2xl font-semibold">$20 <sub className="text-gray-400 text-xs">per month</sub></h3>
          </div>
          <div className="mt-6">
            <h4 className="text-xl font-semibold mb-1">Include</h4>
            <p className="text-sm text-gray-500">Everything you get in this plan</p>
        ...
        <div className="border rounded-md p-6">
          ...
          <div className="mt-6">
            <h3 className="text-2xl font-semibold">$100 <sub className="text-gray-400 text-xs">per month</sub></h3>
          </div>
          <div className="mt-6">
            <h4 className="text-xl font-semibold mb-1">Include</h4>
            <p className="text-sm text-gray-500">Everything you get in this plan</p>
